...
Menge (Set):: 
wie eine Liste, jedoch kein Element kommt mehrfach darin vor
...
* ein Modul vollständig benutzen

----
import Modulname
----

* nur einen Teil eines Moduls benutzen

----
from Modulname import Funktion
----

* ein Modul unter einem anderen Namen einbinden
...
** keine Kennzeichnung des Funktionstyps erforderlich
...
* Dokumentation zu Python 3.14, https://docs.python.org/3.14/index.html
