...
def triangles(pointList, colour="white", withEdges=False):
    setColour(colour)
...
def main():
    ...
    while True:
        ...
        # display two triangles in green, and blue colour
        p1 = (-1.5, -0.5, 0)
        p2 = (-1.5, -1.5, 0)
        p3 = (-0.5, -0.5, 0)
        p4 = (0, -1.5, 2)
        triangles([p1, p2, p3], colour="green", withEdges=True)
        triangles([p2, p3, p4], colour="blue", withEdges=True)
